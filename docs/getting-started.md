...
![img.png](assets/getting_started/list-transformers-example.png)
...
![img.png](assets/getting_started/validate-result.png)
...
![img.png](assets/getting_started/list-dumps.png)
...
It is a simple case of usage. Greenmask has a variety of transformation cases if you want to make a deep dive continue 
exploring the documentation and do not hesitate to ask any questions via [Discord](https://discord.gg/97AKHdGD),
[Telegram](https://t.me/greenmask_community) or [support@greenmask.io](mailto:support@greenmask.io).
